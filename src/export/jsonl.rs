...
pub async fn export_jsonl(opts: &super::ExportOptions) -> Result<usize> {
    ...
    let record_count = for_each_export_row(opts, |export_row| {
        ...
        let mut json_obj = json!({
            ...
            "initial_url": export_row.main.initial_url,
            "final_url": export_row.main.final_url,
            ...
            "dns": {
                ...
                "cname_records": export_row.cname_records,
                "cname_count": export_row.cname_count,
                "ipv6_addresses": export_row.ipv6_addresses,
                "ipv6_count": export_row.ipv6_count,
                "caa_records": export_row.caa_records.iter().map(|r| json!({"flag": r.flag, "tag": r.tag, "value": r.value})).collect::<Vec<_>>(),
                "caa_count": export_row.caa_count,
            },
